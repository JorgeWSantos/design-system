...
- feat: 🎸 Melhorias nos componentes
...
- release: 🦋 Nova versão react/icons/tokens
...
- release: 🦋 Novas versões dos packs react/tokens/icons
...
- feat: 🎸 Adicionará o TableWithLoader

## 2.0.7

### Patch Changes

- feat: 🎸 Adição de novo componente

## 2.0.6

### Patch Changes

- release: 🦋 Nova versão do react
