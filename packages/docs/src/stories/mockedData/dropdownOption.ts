import { DataDropdown } from '@abqm-ds/react';

export const optionsStates: DataDropdown[] = [
...
export const options1: DataDropdown[] = [
  { value: '', label: 'Todos', id: '' },
  { value: 'a', label: 'aaaa', id: '0' },
  { value: 'b', label: 'bbbbb', id: '1' },
  { value: 'c', label: 'ccccc', id: '2' },
];
